...
def jatekos_Nagyobb21_Ugyanannyilap_Teszt14():
    jatekos = [11,10,5]
    gep = [5,5,5]
...
def gep_Nagyobb21_Ugyanannyilap_Teszt15():
    jatekos = [5,6,5]
    gep = [9,9,9]
...
def teszt():
    ...
    gep_Nyer_Kevesebblap_Teszt13()
    jatekos_Nagyobb21_Ugyanannyilap_Teszt14()
    gep_Nagyobb21_Ugyanannyilap_Teszt15()
